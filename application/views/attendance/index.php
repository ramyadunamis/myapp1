...
<table class="table table-striped table-bordered">
    ...
    <tr>
		<td><?php echo $i+1; ?></td>
		<td><?php echo $A['at_child_id']; ?></td>
		<td><?php echo $A['at_trip_id']; ?></td>
		<td><?php echo $A['at_time_stamp']; ?></td>
		...
		<td>
<!--            <a href="<?php echo site_url('attendance/edit/'.$A['at_id']); ?>" class="btn btn-info">Edit</a> -->
            <a onClick="javascript: return confirm('Are you sure you want to delete this record?');" href="<?php echo site_url('attendance/remove/'.$A['at_id']); ?>" class="btn btn-danger">Delete</a>
        </td>
    </tr>
	<?php $i++; } ?>
</table>
