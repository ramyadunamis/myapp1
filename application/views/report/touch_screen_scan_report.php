...
<!--              <div class="title_right">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Touch Screen Report <small></small></h2>
                 ...
                 <div class="pull">
                 <?php echo form_open('report/search_touch_screen_scan_report',array("class"=>"form-horizontal",'method'=>"get")); ?>    
                     Date: <input type="text" id="dateTo" name="date" value="<?php if($this->input->get('date')){echo $this->input->get('date');} else{ echo date("m/d/Y");} ?>">
                    <br/>
