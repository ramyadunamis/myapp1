...
<!--              <div class="title_right">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Students Report <small></small></h2>
                 ...
                 <div class="pull">
                 <?php echo form_open('report/search_count_csv',array("class"=>"form-horizontal",'method'=>"get")); ?>    
                    From: <input type="text" id="datefrom" name="datefrom" value="<?php if($this->input->get('datefrom')){echo $this->input->get('datefrom');} else{ echo date("m/d/Y", strtotime("-1 months"));} ?>">
                    
                     To: <input type="text" id="dateTo" name="dateTo" value="<?php if($this->input->get('dateTo')){echo $this->input->get('dateTo');} else{ echo date("m/d/Y");} ?>">
                    <br/>
