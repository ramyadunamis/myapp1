...
<?php echo form_open_multipart('trip/add_csv',array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="trip_name" class="col-md-4 control-label">Upload CSV</label>
		<div class="col-md-8">
			<input type="file" name="csv" class="form-control" id="trip_name" />
		</div>
	</div>
