...
<!--              <div class="title_right">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                <?php echo form_open('device_app_user/edit/'.$device_app_user['device_app_user_id'],array("class"=>"form-horizontal")); ?>

                      
          <div class="form-group">
		<label for="device_app_user_name" class="col-md-4 control-label"><span class="text-danger">*</span>Device App User Name</label>
		<div class="col-md-8">
			<input type="text" name="device_app_user_name" value="<?php echo ($this->input->post('device_app_user_name') ? $this->input->post('device_app_user_name') : $device_app_user['device_app_user_name']); ?>" class="form-control" id="device_app_user_name" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="device_app_user_password" value="<?php echo ($this->input->post('device_app_user_password') ? $this->input->post('device_app_user_password') : $device_app_user['device_app_user_password']); ?>" class="form-control" id="device_app_user_password" />
	 ...
	 <div class="form-group">
		...
		<div class="col-md-8">
              ...
              <option value="<?php echo $B['device_id'];?>" <?php if(($B['device_id'])==($device_app_user['device_app_user_device_id'])){ ?> selected <?php } ?>><?php echo $B['device_name'];?></option>
                    <?php } ?>
            ...
            <option value="0" <?php if(($device_app_user['device_user_type'])=='0'){ ?> selected <?php } ?>>Admin</option>
            <option value="1" <?php if(($device_app_user['device_user_type'])=='1'){ ?> selected <?php } ?>>Others</option>
            </select>
            </div>
            </div>
