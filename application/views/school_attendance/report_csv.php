...
<!--              <div class="title_right">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Report in CSV <small></small></h2>
                   
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                 <div class="pull">
                 <?php echo form_open('school_attendance/search_csv',array("class"=>"form-horizontal",'method'=>"get")); ?>    
                    Date: <input type="text" id="datepicker" name="date" value="<?php if($this->input->get('date')){echo $this->input->get('date');} else{ echo date("m/d/Y");} ?>"><br/>
