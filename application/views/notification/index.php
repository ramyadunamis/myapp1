            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                 <div class="pull">
                 <?php echo form_open('notification/search',array("class"=>"form-horizontal",'method'=>"get")); ?>    
                   Child Name: <select name="child_id" >
                        <option selected="selected">...Select Child Name...</option>
                        <?php  foreach($child as $C){ ?>

                        <option value="<?php echo $C['child_id'];?>" <?php if( $this->input->get('child_id')==$C['child_id']) {?> selected <?php } ?>><?php echo $C['child_name'];?></option>
                        <?php } ?>
                       </select>
...
<!--	<a href="<?php echo site_url('notification/add'); ?>" class="btn btn-success">Add</a> -->
</div>
...
<table class="table table-striped table-bordered">
    ...
    <tr>
		<td><?php echo $i; ?></td>
		<td><?php echo $N['n_title']; ?></td>
		<td><?php echo $N['n_msg']; ?></td>
		<td><?php echo $N['n_time_stamp']; ?></td>
		<td><?php echo $N['n_send_type']; ?></td>
		<td><?php echo $N['n_type']; ?></td>
                 <td><?php echo $N['n_child_id']; ?></td>
