...
<!--              <div class="title_right">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>ADD USER DETAILS <small></small></h2>
...
<?php echo form_open_multipart('user/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="radio" name="user_gender" value="male" value="<?php echo $this->input->post('user_gender'); ?>" id="user_gender" checked="checked"/>Male
                        <input type="radio" name="user_gender" value="female" value="<?php echo $this->input->post('user_gender'); ?>" id="user_gender" />Female
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="user_phone" value="<?php echo $this->input->post('user_phone'); ?>" class="form-control" id="user_phone" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="user_place" value="<?php echo $this->input->post('user_place'); ?>" class="form-control" id="user_place" />
		</div>
	</div>
<!--	<div class="form-group">
...
<!--	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="user_auth_code" value="<?php echo $this->input->post('user_auth_code'); ?>" class="form-control" id="user_auth_code" />
		</div>
	</div>
<!--	<div class="form-group">
...
<!--	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="user_updated_timestamp" value="<?php echo $this->input->post('user_updated_timestamp'); ?>" class="form-control" id="user_updated_timestamp" />
		</div>
	</div>-->
